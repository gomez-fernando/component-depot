                    ...
                    <table class="table table-striped">
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
{{--                                    <a href="{{ route('category.delete', ['id' => $category->id]) }}" class="btn btn-sm btn-danger">Eliminar categoría</a>--}}
                                    <!-- Button to Open the Modal -->
                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModal-{{ $category->id }}">
                                        Eliminar categoría
                                    </button>
